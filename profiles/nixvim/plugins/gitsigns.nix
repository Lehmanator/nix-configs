...
{
  # Highlight cursor line number without cursorline
  # NOTE: `options` cant be set in standalone nixvim bc conflicts w/ module system attr.
  ...
  plugins.gitsigns = {
    # TODO: Read from host config (home-manager/NixOS/darwin/devshells)
    enable = lib.mkDefault true; # config.programs.git.enable;
    gitPackage =
      lib.mkDefault pkgs.gitAndTools.gitFull; # config.programs.git.package;
