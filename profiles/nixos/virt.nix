{ inputs, config, lib, pkgs, user, ... }: {
  imports = [
    ...
    inputs.self.nixosProfiles.appimage
    inputs.self.nixosProfiles.containerd
    inputs.self.nixosProfiles.cri-o
    inputs.self.nixosProfiles.podman
    inputs.self.nixosProfiles.waydroid
    inputs.self.nixosProfiles.wine

    #inputs.self.nixosProfiles.lxc
    #inputs.self.nixosProfiles.lxd
    #inputs.self.nixosProfiles.lxd-image-server

    # --- Virtual Machines ---
    inputs.self.nixosProfiles.qemu
    inputs.self.nixosProfiles.qemu-web
    inputs.self.nixosProfiles.kvm
    inputs.self.nixosProfiles.libvirt
    inputs.self.nixosProfiles.vm-guest-windows
    inputs.self.nixosProfiles.vm-host
  ];
