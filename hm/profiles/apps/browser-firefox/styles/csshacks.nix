...
let
  ...
  alpha = builtins.fetchGit {
    url = "https://github.com/Tagggar/Firefox-Alpha";
    rev = "78bf9a9ea57538b0a58212731e81dea80d490105";
  };
  csshacks = builtins.fetchGit {
    url = "https://github.com/MrOtherGuy/firefox-csshacks";
    rev = "67a9e9f9c96e6d007b4c57f1dd7eaceaee135178";
  };
  impossible = builtins.fetchGit {
    url = "https://github.com/Naezr/ImpossibleFox";
    rev = "a0a34595bc498abdab0e8c52c424762b994a6283";
  };
  material = builtins.fetchGit {
    url = "https://github.com/muckSponge/MaterialFox";
    rev = "8b1a7b10da0751a1f63e51eac428ba1eb1094b5f";
  };
  rounded = builtins.fetchGit {
    url = "https://github.com/Etesam913/rounded-fox";
    rev = "fbcffb41d67123f42a48430510991ba5503c0587";
  };
  wave = builtins.fetchGit {
    url = "https://github.com/QNetITQ/WaveFox";
    rev = "b4ddefc4e2bfccd7f809eca2b819e9a95ffbf2c2";
  };
  csshack-cool = [
...
in
{
  ...
  userChrome = ''
    ...
    @import "${gnome}/theme/extensions/adaptive-tab-bar-color.css";
    @import "${gnome}/theme/extensions/tab-center-reborn.css";
    @import "${sidebar}/userChrome.css";
    @import "${sidebar}/themes/gtk_adwaita.css";
    @import "${csshacks}/chrome/autohide_sidebar.css";
    @import "${csshacks}/chrome/compact_extensions_panel.css";
    @import "${csshacks}/chrome/urlbar_connection_type_text_colors.css";
    @import "${csshacks}/chrome/urlbar_connection_type_background_colors.css";
    @import "${csshacks}/chrome/urlbar_container_color_border.css";
    @import "${csshacks}/chrome/multi-row-bookmarks.css";
    @import "${csshacks}/chrome/page_action_buttons_on_urlbar_hover.css";
    @import "${csshacks}/chrome/tab-hover-preview.css";
  '';
