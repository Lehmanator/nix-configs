...
}:
{
  ...
  # --- OIDC Keycloak Endpoints & Config ---
  #
  #  Response from .well-known endpoint
  #    Found: (>18.0) https://<host>:<port>/realms/<realm>/.well-known/openid-configuration
  #    Found: (<18.0) https://<host>:<port>/auth/realms/<realm>/.well-known/openid-configuration
  #
  #{ "issuer": "https://{KC_HOST}:{KC_PORT}/realms/{realm}",
  #  "authorization_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/auth",
  #  "token_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/token",
  #  "introspection_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/token/introspect",
  #  "userinfo_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/userinfo",
  #  "end_session_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/logout",
  #  "revocation_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/revoke",
  #  "device_authorization_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/auth/device",
  #  "backchannel_authentication_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/ext/ciba/auth",
  #  "pushed_authorization_request_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/ext/par/request",
  #  "registration_endpoint": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/clients-registrations/openid-connect",
  #  "jwks_uri": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/certs",
  #  "check_session_iframe": "https://{KC_HOST}:{KC_PORT}/realms/{realm}/protocol/openid-connect/login-status-iframe.html",
  ...
  #  "scopes_supported": [ "openid", "phone", "roles", "microprofile-jwt", "email", "web-origins", "offline_access", "address", "profile" ],
