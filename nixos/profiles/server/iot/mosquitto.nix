{pkgs, ...}: {
  ...
  services.mosquitto = {
    ...
    bridges = {
      # <name> = {
      #   addresses = [{ address="192.168.1.160"; port=1883; }];
      #   settings = { };
      #   topics = ["# both 2 local/topic/ remote/topic/"];
      # };
    };
    ...
    listeners = {
      # <name> = {
      #   acl = ["pattern read #" "topic readwrite anon/report/#"];
      #   address = "0.0.0.0/::";
      #   # https://mosquitto.org/man/mosquitto-conf-5.html
      #   authPlugins = [{ denySpecialChars = true; options = {}; plugin = <path>.so; }];
