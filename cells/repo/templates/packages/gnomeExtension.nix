# GNOME Shell Extension Library Function
#
# Arg: Metadata attrset of GNOME Shell Extension
#
# {  uuid = "<ExtensionShortName>@<URL>";
#    name = "<Name>";
#    pname = "<PackageName>";
#    description = "<Desc>";
#    link = "<GnomeExtensionsPage>";
#    shell_version_map = {
#      44 = { version = 22; sha256 = "<HashSHA256>"; };
#      ...
#    };
# }
#
# Notes:
# - Can provide JSON list of extensions and use lib to convert to attrset
# - Nixpkgs uses JSON
{ 
  lib, pkgs,
  stdenv,
