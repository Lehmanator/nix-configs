{
  ...
  inputs = {
    ...
    }; # xtras: flake-utils-plus, flake-compat
    snowflake-os = {
    ...
    }; # xtras: nix-software-center, nixos-conf-editor, snow, snowflake-os-module-manager snowfall-lib
    snowfall-flake = {
    ...
    }; # xtra: devshell,flake-utils
    nixpkgs-wayland = {
      inputs.nixpkgs.follows = "nixpkgs";
      url = "github:nix-community/nixpkgs-wayland";
    }; # xtra: lib-aggregate,nix-eval-jobs,flake-compat
    firefox = {
      #inputs.nixpkgs.follows="nixpkgs";
      url = "github:nix-community/flake-firefox-nightly";
    }; # xtra: lib-aggregate, cachix, mozilla, flake-compat
    nixGL = {
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    }; # xtra: flake-parts, treefmt-nix
    neovim = {
      inputs.nixpkgs.follows = "nixpkgs";
      url = "github:nix-community/neovim-nightly-overlay";
    }; # xtra: flake-parts, hercules-ci-effects, flake-compat, git-hooks, treefmt-nix
    ...
    }; # xtra: flake-parts,haskell-flake
    # --- Modules: Secrets -----------------------------------------
    agenix = {
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    debnix = {
      # Translate package names Nix <-> Debian
