{ inputs, osConfig, config, lib, pkgs, ... }: {
  imports = [
    ...
    #./audio-editors.nix
    #./audio-players.nix
    inputs.self.homeProfiles.apps-gnome-amberol
    inputs.self.homeProfiles.apps-gnome-cozy
    inputs.self.homeProfiles.apps-gnome-decibels

    #./photo-recorders.nix
    #./photo-editors.nix
    #./photo-players.nix
    inputs.self.homeProfiles.apps-gnome-loupe
  ...
  home.packages = [
    ...
    #pkgs.zrythm #                   # Digital audio workstation (build failing as of 1/15/23: dep=pyhton3.11-kiss-headers-2.4.3)
    # --- View ------
