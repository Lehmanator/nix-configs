...
in
{
  ...
  nix.settings = {
    ...
    substituters = defaults.substituters
      ++ [ "https://nix-community.cachix.org/" ];
    extra-substituters = defaults.extra-substituters ++ [
    ...
    trusted-substituters = defaults.trusted-substituters ++ [
      "https://hydra.nixos.org/"
      "https://nix-community.cachix.org/"
      "https://lehmanator.cachix.org/"
    ];
    extra-trusted-substituters = defaults.extra-trusted-substituters ++ [
      "https://nix-on-droid.cachix.org/"
      "https://robotnix.cachix.org/"
      "https://nrdxp.cachix.org/"
      "https://numtide.cachix.org/"
    ...
    trusted-public-keys = defaults.trusted-public-keys ++ [
      "hydra.nixos.org-1:CNHJZBh9K4tP3EKF6FkkgeVYsS3ohTl+oS0Qa8bezVs="
      "nix-community.cachix.org-1:mB9FSh9qf2dCimDSUo8Zy7bkq5CX+/rkCWyvRCYg3Fs="
      "lehmanator.cachix.org-1:kT+TO3tnSoz+lxk2YZSsMOtVRZ7Gc57jaKWL57ox1wU="
    ];
    extra-trusted-public-keys = defaults.extra-trusted-public-keys ++ [
