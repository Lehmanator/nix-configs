# (pkgs.nixos [
{
  ...
  in {
    ...
    split =
      false; # Enables generation of split artifacts from partitions. If true, for each partition w/ SplitName= set, generates separate output file containing the partition contents.
