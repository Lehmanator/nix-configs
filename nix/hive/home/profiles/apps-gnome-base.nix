{ inputs, config, lib, pkgs, ... }: {
  imports = [
    ...
    inputs.self.homeProfiles.apps-gnome-chat
    inputs.self.homeProfiles.apps-gnome-dbus
    inputs.self.homeProfiles.apps-gnome-developer
    inputs.self.homeProfiles.apps-gnome-finance
    inputs.self.homeProfiles.apps-gnome-multimedia
    inputs.self.homeProfiles.apps-gnome-productive
    inputs.self.homeProfiles.apps-gnome-reading
    inputs.self.homeProfiles.apps-gnome-security
    inputs.self.homeProfiles.apps-gnome-social
    inputs.self.homeProfiles.apps-gnome-translate

    # --- Individual Apps ---
    # TODO: Move all apps to use dir structure: `./<appName>/{default,settings}.nix`
    # TODO: Use `./<category>.nix` to import these.
    inputs.self.homeProfiles.app-gnome-calculator
    inputs.self.homeProfiles.app-gnome-gradience
    inputs.self.homeProfiles.app-gnome-valent
  ];
