...
# TODO: Move borderStyle & theme logic to separate Nix module
{
  plugins = {
    ...
    cmp-fish.enable = lib.mkDefault false;
    #homeConfig.programs.fish.enable or false; # Fish shell keywords
    ...
    cmp-pandoc-nvim.enable =
      lib.mkDefault true; # homeConfig.programs.pandoc.enable; # Pandoc
    cmp-pandoc-references.enable =
      lib.mkDefault true; # config.plugins.cmp-pandoc-references.enable;
    #homeConfig.programs.pandoc.enable; # Pandoc references
    ...
    cmp-tmux.enable =
      lib.mkDefault true; # homeConfig.programs.tmux.enable; # Tmux words
    cmp-vimwiki-tags.enable = false; # VimWiki tags
    cmp-zsh.enable =
      lib.mkDefault true; # homeConfig.programs.zsh.enable; # Zsh keywords
    cmp_luasnip.enable = config.plugins.luasnip.enable;
    ...
    cmp = {
      ...
      settings = {
        ...
        window.completion = {
          ...
          winhighlight =
            "Normal:Pmenu,FloatBorder:Pmenu,CursorLine:PmenuSel,Search:None"; # Window highlight option. See: |nvim_open_win|. Default = null => "Normal:Pmenu,FloatBorder:Pmenu,CursorLine:PmenuSel,Search:None"
